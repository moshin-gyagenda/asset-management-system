        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <a href="{{ route('create-category')}}" class="btn btn-sm btn-primary float-end" style="margin-top: 40px;"><i class="fa fa-plus"></i> Add Category</a>
                            ...
                            <h5 class="card-title" style="color: #fff;">Category List</h5>

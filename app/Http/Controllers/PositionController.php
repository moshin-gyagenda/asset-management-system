...
class PositionController extends Controller
{
    ...
    {
        return view('dashboard.create-position');
    }
    ...
    public function store(Request $request)
    {
        ...
        $position->position_name = $validatedData['position_name'];
        $position->description = $validatedData['description'];

        // Check if the position was saved successfully
        if ($position->save()) {
